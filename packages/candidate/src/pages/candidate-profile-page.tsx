    ...
    >
      ...
      <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
        <SectionCard
          ...
          description="Each project is a candidate-owned artifact that recruiters can read alongside recommendation-backed evidence."
        >
        ...
        <SectionCard
          ...
          description="Candidates choose which submitted recommendations to display, but they do not control the content."
        >
          <div className="grid gap-4">
